...
# Этот код создает класс Rectangle с методами для вычисления периметра, площади, а также магическими методами для сложения, вычитания и сравнения прямоугольников. 